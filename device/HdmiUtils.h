...
#ifndef HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_HDMIUTILS_H_
#define HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_HDMIUTILS_H_
...
struct HdmiConfig {
    ...
    static HdmiConfig loadFromCfg(const char* cfgPath = kDefaultCfgPath);

    // CameraId base offset for numerical representation
    uint32_t cameraIdOffset;

    // List of internal V4L2 video nodes hdmi HAL must ignore.
...
#endif  // HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_HDMIUTILS_H_
