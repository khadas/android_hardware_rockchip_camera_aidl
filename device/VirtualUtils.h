...
#ifndef HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_VIRTUALUTILS_H_
#define HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_VIRTUALUTILS_H_
...
struct VirtualConfig {
    ...
    static VirtualConfig loadFromCfg(const char* cfgPath = kDefaultCfgPath);

    // CameraId base offset for numerical representation
    uint32_t cameraIdOffset;

    // List of internal V4L2 video nodes virtual HAL must ignore.
...
#endif  // HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_VIRTUALUTILS_H_
