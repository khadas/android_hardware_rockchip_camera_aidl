...
#ifndef HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_VIRTUALDEVICE_H_
#define HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_VIRTUALDEVICE_H_
...
class VirtualDevice : public BnCameraDevice {
  public:
    ...
    // camera is detached.
    VirtualDevice(const std::string& devicePath, const VirtualConfig& config);
  ...
  private:
    virtual std::shared_ptr<VirtualDeviceSession> createSession(
            const std::shared_ptr<ICameraDeviceCallback>&, const VirtualConfig& cfg,
    ...
    std::weak_ptr<VirtualDeviceSession> mSession =
            std::weak_ptr<VirtualDeviceSession>();
...
#endif  // HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_VIRTUALDEVICE_H_
