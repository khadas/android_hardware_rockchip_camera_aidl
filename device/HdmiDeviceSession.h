...
#ifndef HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_HDMIDEVICESESSION_H_
#define HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_HDMIDEVICESESSION_H_
...
class HdmiDeviceSession : public BnCameraDeviceSession, public OutputThreadInterface {
  public:
    HdmiDeviceSession(const std::shared_ptr<ICameraDeviceCallback>&,
                                const HdmiConfig& cfg,
                                const std::vector<SupportedV4L2Format>& sortedFormats,
                                const CroppingType& croppingType,
                                const common::V1_0::helper::CameraMetadata& chars,
                                const std::string& cameraId, unique_fd v4l2Fd);
    ~HdmiDeviceSession() override;
...
#endif  // HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_HDMIDEVICESESSION_H_
